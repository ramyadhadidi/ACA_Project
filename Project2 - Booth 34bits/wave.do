...
add wave -noupdate -format Literal -radix hexadecimal /multiplier__tb/c
add wave -noupdate -format Literal -radix hexadecimal /multiplier__tb/d
add wave -noupdate -format Literal -radix hexadecimal /multiplier__tb/q
